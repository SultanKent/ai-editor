// components/services/LiteraryTranslation.jsx
...
const LiteraryTranslation = () => {
  ...
  const handleSubmit = async () => {
    ...
    const translationPrompt = `Translate the following text into high-quality, polished literary English. обезательно ответить на том языке на которым ответили запрос Text: ${inputText}`;
    ...
    try {
      ...
      setError('Произошла ошибка при переводе текста.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="service-container">
      <div className="service-content">
        <div className="service-input">
          <h2>Литературный перевод на английский</h2>
          <textarea
            value={inputText}
